...
# Embedded file name: topology.py
...
class NetworkTopo(Topo):
    ...
    def build(self, **_opts):
        ...
        self.addLink(s1, r1, intfName2='r1-eth1', params2={'ip': '10.10.101.1/24'},
          bw=(band[6]),
          delay=(dela[6]),
          loss=(los[6]))
        self.addLink(s2, r2, intfName2='r2-eth1', params2={'ip': '10.10.102.1/24'},
          bw=(band[7]),
          delay=(dela[7]),
          loss=(los[7]))
        self.addLink(s3, r3, intfName2='r3-eth1', params2={'ip': '10.10.103.1/24'},
          bw=(band[8]),
          delay=(dela[8]),
          loss=(los[8]))
        self.addLink(s0, r0, intfName2='r0-eth1', params2={'ip': '10.10.200.1/24'},
          bw=0.02,
          delay='0ms',
          loss=0)
        self.addLink(r1, r0, intfName1='r1-eth2',
          intfName2='r0-eth2',
          ...
          delay=(dela[9]),
          loss=(los[9]))
        self.addLink(r2, r0, intfName1='r2-eth2',
          intfName2='r0-eth3',
          ...
          delay=(dela[10]),
          loss=(los[10]))
        self.addLink(r3, r0, intfName1='r3-eth2',
          intfName2='r0-eth4',
          ...
          delay=(dela[11]),
          loss=(los[11]))
        h1 = self.addHost('h1', ip='10.10.101.2/24', defaultRoute='via 10.10.101.1')
        h2 = self.addHost('h2', ip='10.10.101.3/24', defaultRoute='via 10.10.101.1')
        h3 = self.addHost('h3', ip='10.10.102.2/24', defaultRoute='via 10.10.102.1')
        h4 = self.addHost('h4', ip='10.10.102.3/24', defaultRoute='via 10.10.102.1')
        h5 = self.addHost('h5', ip='10.10.103.2/24', defaultRoute='via 10.10.103.1')
        h6 = self.addHost('h6', ip='10.10.103.3/24', defaultRoute='via 10.10.103.1')
        c1 = self.addHost('c1', ip='10.10.200.2/24', defaultRoute='via 10.10.200.1')
...
def run():
    ...
    parser.add_argument('user', help='your moodle username')
    parser.add_argument('-t', '--test', help='set it if you want to run tests',
      action='store_true')
